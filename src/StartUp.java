...
public class StartUp extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(event == login){
            try {
                ...
                Session user = new Session(username.getText(), password.getText(),this, true);
            ...
            try {
                ...
                Session user = new Session(username.getText(), password.getText(),this, false);
    ...
    public static void main(String args[]) {
        StartUp s =new StartUp("Log in/Sign up");
